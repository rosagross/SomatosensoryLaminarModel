...
double precision :: v_v1(1)
double precision :: x_v1(1)
double precision :: v_v2(1)
double precision :: x_v2(1)
double precision :: v_v3(1)
double precision :: x_v3(1)
double precision :: m_v2(1)
double precision :: m_in_v2(1)
double precision :: m(1)
double precision :: m_in_v3(1)
double precision :: m_v1(1)
double precision :: m_in(1)
double precision :: m_in_v1(1)
double precision, intent(inout) :: dy(8)
double precision, intent(in) :: u(1)
...
dy(1:1) = x
dy(2:2) = h*(m_in + u)/tau - 2*x/tau - v/tau**2
dy(3:3) = x_v1
dy(4:4) = h_v1*m_in_v1/tau_v1 - 2*x_v1/tau_v1 - v_v1/tau_v1**2
dy(5:5) = x_v2
dy(6:6) = h_v2*m_in_v2/tau_v2 - 2*x_v2/tau_v2 - v_v2/tau_v2**2
dy(7:7) = x_v3
dy(8:8) = h_v3*m_in_v3/tau_v3 - 2*x_v3/tau_v3 - v_v3/tau_v3**2
