"""extrinsic inputs: rates, not potentials!
...
jrc_extended_rate = CircuitTemplate(
...
jrc_auto = ODESystem.from_template(jrc_extended_rate, auto_dir=auto_dir, init_cont = False, NPR=100, NMX=30000)
