...
results = jrc.run(simulation_time=2.0,
                  ...
                  outputs={'V_E1': 'V4/RPO_E1/v', #Eingänge nach P1
                           'V_P1': 'V4/RPO_E2/v',
                           'V_S1': 'V4/RPO_E3/v',
                           'V_V1': 'V4/RPO_E4/v'},#outputs,
                  backend='default',
                  solver='scipy',
                  vectorize = False)
...
potential_syn = pd.DataFrame(results)
potential_syn.to_csv('output/pyrates_up_syn.csv', index=False)
