...
model.update_var(node_vars={'thalE/InputOp/dur': input_duration/step_size}) 
model.update_var(node_vars={'thalE/InputOp/onset': input_onset/step_size})
model.update_var(node_vars={'BACKGROUND/RPO_bI/bI': backgrndI_strengths})
model.update_var(node_vars={'BEI/bEI_definition/bEI_input': bEI})
model.update_var(node_vars={'BEI_THAL/bEI_thal_definition/bEI_thal_input': bEI_thal})
model.update_var(node_vars={'G/g_definition/g_input': g})
...
param_map = {#'input_strength': {'vars': ['thalE/InputOp/A'], 'nodes': ['thalE']},
            ...
            'g_thal': {'vars': ['G_THAL/g_thal_definition/g_thal_input'], 'nodes': ['G_THAL']}
