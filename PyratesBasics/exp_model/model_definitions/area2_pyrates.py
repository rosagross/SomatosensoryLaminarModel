...
rpos = [deepcopy(rpo).update_template(name=rpo_names[i], variables={"tau": tau_a2[i]}) for i in range(N_cells)]
...
for i, cell_i in enumerate(cells):
    ...
    for j, cell_j in enumerate(cells):
        edges.append((f'{cell_j}/{pro_names[j]}/m_out', f'{cell_i}/{rpo_names[j]}/m_in', None, {'weight': W_A2[i,j]}))

# Set up the Model Circuit 
area_2 = CircuitTemplate(
    name = 'area_2',
...
circuit_to_yaml(area_2, "area_2.yaml")
...
# %%
results = area_2.run(simulation_time=2.0,
                  step_size=1e-3,
...
filename_potentials = "only_a2_potentials.png"
...
# %% plot - rates
filename_rates = "only_a2_rates.png"
