...
input_strength = 50 #[0, 50, 300, 500] #np.arange(0, 500, 100) - 10000
backgrndI_strengths = 200 #[0, 5, 10, 15, 20] - 10000
step_size=1e-3
...
t_sols, t_cont = area_a3b_thal_bI_iext_auto.run(
    c='ivp',  name='time', DS=1e-5, DSMIN=1e-8, EPSL=1e-05, EPSU=1e-05, EPSS=1e-03,
    DSMAX=1e-4, NMX=100000000, UZR={14: simulation_time}, STOP={'UZ1'})
