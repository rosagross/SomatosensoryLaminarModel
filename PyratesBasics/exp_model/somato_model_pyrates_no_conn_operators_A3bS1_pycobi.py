...
class SomatoModelPyrates():
    ...
    def simulate(self):
        ...
        self.rate = m_out_all
        """
    def pyrates_plot(self,title,save_path=None):
        # division into layers
        layers = [self.potential_df.columns[:4],   # first 4 
          self.potential_df.columns[4:]  # next 4
         ]
    ...
    def pycobi_continuation(self, cont_param, range, auto_dir_path, equilibrium_csv_path=None):
        # optional equilibrium values --> easier initial time cont in PyCobi
