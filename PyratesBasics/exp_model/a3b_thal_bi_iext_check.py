...
bI_definition = OperatorTemplate(
            ...
            variables={"bI1": "output", "backgrndI_strengths": f'input({backgrndI_strengths})'}
            )
...
all_node_names = cells + ["background_input"] # --> needed for the "layering"
...
"""
# %%
circuit_to_yaml(area_a3b_thal_bI_iext, "area_a3b_thal_bI_iext_2026.yaml")
...
outputs_original = {v: k for k, v in outputs.items()}
# %%
...
equilibrium_df.to_csv("equilibrium_df_A3b.csv", index=False)
# %% Pandas Dataframe
all_potentials = []
