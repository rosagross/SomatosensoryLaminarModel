...
if safe_results:
    cells = np.array(['E1', 'E2', 'E3', 'E4', 'P1', 'P2', 'P3', 'P4','S1', 'S2'])
    ...
    potential_df.to_csv(f'output/python_10.csv', index=False)


#%%

plt.plot(potential[2, 0], label='E1') #Eingänge nach P1 (target, source)
